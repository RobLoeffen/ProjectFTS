        ...
        <h3 class="text-2xl font-bold text-center mb-4 text-gray-800 dark:text-white flex items-center justify-center">
            <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M21 15.5V10c0-1.7-1.3-3-3-3h-1V4c0-.6-.4-1-1-1s-1 .4-1 1v3h-2V4c0-.6-.4-1-1-1s-1 .4-1 1v3H9V4c0-.6-.4-1-1-1S7 3.4 7 4v3H6c-1.7 0-3 1.3-3 3v5.5c0 1.9 1.3 3.5 3 3.5h12c1.7 0 3-1.6 3-3.5zM6 16V10h12v6H6z"></path>
            </svg>
            Available Festivals
        </h3>
    </div>
    ...
    @if(auth()->user()->role === 'customer')
        <div class="flex justify-center mt-4">
            <a href="{{ route('festivals') }}"
               class="bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700 transition-colors duration-200 flex items-center space-x-2">
    ...
    @if(auth()->user()->role === 'customer')
        <div class="relative w-full max-w-2xl mx-auto mt-8">
            ...
            @if(auth()->user()->buses->isEmpty())
                <div
                    class="bg-gradient-to-r from-indigo-600 to-blue-700 rounded-lg overflow-hidden shadow-lg mb-4 p-8 text-center">
                    <svg class="w-16 h-16 mx-auto mb-4 text-white" fill="none" stroke="currentColor"
                         viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @else
                @foreach(auth()->user()->buses->take(3) as $bus)
                    <div
                        class="bg-gradient-to-r from-indigo-600 to-blue-700 rounded-lg overflow-hidden shadow-lg mb-4 transform transition-transform hover:scale-102">
                ...
                <div class="max-w-2xl mx-auto mt-8">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        @foreach($users->take(4) as $user)
                            <div
                                class="bg-gradient-to-r from-indigo-600 to-blue-700 rounded-lg p-4 text-center cursor-pointer hover:from-indigo-700 hover:to-blue-800 transition-colors duration-200 transform hover:scale-102">
